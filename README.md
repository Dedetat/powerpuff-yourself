...
> First of all we add the `edited` field and declare it as a reference
 1. We create a new field named `edited` which contains the reference to the Powerpuff that is edited 💡. You can see it like the reference which an editing screen can work with
